...
struct StoryBrain {
    ...
    func getChoices() -> Array<String> {
        return [stories[story].choice1, stories[story].choice2]
    }
    
    mutating func setNextStory(choice: Int) {
        if choice == 1{
            story = stories[story].choice1Destination
        }else{
            story = stories[story].choice2Destination
        }
    }
